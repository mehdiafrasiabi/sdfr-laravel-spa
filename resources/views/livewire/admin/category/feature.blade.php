        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>ویژگی دسته بندی  :
                            <span wire:ignore style="color: #29971d">{{$categoryName}}</span>
                        </h4>
            ...
            <div class="widget-content widget-content-area">
                ...
                <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <label for="name" class="form-label">ویژگی  :
                    ...
                    <a  href="{{route('admin.category.index')}}" class="btn btn-danger btn-lg _effect--ripple waves-effect waves-light">
                        <span >بازگشت</span>
                    </a>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">{{$categoryFeature->name}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="action-btns">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit({{$categoryFeature->id}})"
                                        ...
                                        <a href="javascript:void(0);"
                                           ...
                                           wire:click="delete({{$categoryFeature->id}})"
