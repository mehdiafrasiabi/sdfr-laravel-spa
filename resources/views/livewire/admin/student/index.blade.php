                ...
                <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center">
                    <form class="form-inline my-2 my-lg-0">
                        <div class="">
                            ...
                            <input type="text" wire:model.live.debounce.350ms="search" class="form-control product-search"
                                   id="input-search"
                        ...
                        <div class="item-content">
                            <div class="user-profile">
                                <div class="user-meta-info">
                                    <p class="user-name"
                                       data-name="Alan Green">{{$loop->iteration + $students->firstItem() - 1}}</p>
                                </div>
                            </div>
                            <div class="user-profile">
                                <div class="user-meta-info">
                                    <p class="user-name"
                                       data-name="Alan Green">{{$student->payment->order->user->name}}</p>

                                    @foreach($student->payment->order->orderItems as $item)
                                        <p class="user-work"
                                           data-occupation="Web Developer"> {{ $item->product->name ?? 'نامشخص' }}</p>
                                    @endforeach
                                </div>
                            </div>
                            <div class="user-phone">
                                ...
                                <p class="usr-ph-no"
                                   data-phone="+1 (070) 123-4567">{{$student->payment->order->user->mobile}}</p>
                            </div>
                            <div class="user-phone">
                            ...
                            <div class="action-btn">
                                ...
                                <a href="{{route('admin.student.information',$student->payment->order->user->id)}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                         stroke-linejoin="round" class="feather feather-edit-2 edit">
