        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                ...
                <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                    ...
                    >
                        <label for="barnameh" class="form-label">برنامه :</label>
                        <input type="file" class="form-control" id="barnameh" wire:model="barnameh" name="barnameh"
                               placeholder="">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($plans as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/student/{{$studentId}}/plan/{{$item->barnameh}}" class="text-secondary"> مشاهده</a>
                                </td>
                                <td>
