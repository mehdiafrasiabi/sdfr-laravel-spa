                ...
                <div class="task-action">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu left" aria-labelledby="renvenue" style="will-change: transform;">
                            <a class="dropdown-item" href="javascript:void(0);">هفته ای</a>
                            <a class="dropdown-item" href="javascript:void(0);">ماهانه</a>
                            <a class="dropdown-item" href="javascript:void(0);">سالانه</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mt-container-ra mx-auto">
                    <div class="timeline-line">
                        ...
                        <div class="item-timeline timeline-success">
                            ...
                            <div class="t-text">
                                <p>Send Mail to <a href="javascript:void(0);">HR</a> and <a href="javascript:void(0);">Admin</a>
                                </p>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        ...
        <div class="widget widget-wallet-one">
            ...
            <div class="wallet-info text-center mb-3">
                ...
                <p class="wallet-title mb-3">کل موجودی</p>
            ...
            <ul class="list-group list-group-media">
                ...
                <li class="list-group-item">
                    <div class="media">
                        <div class="me-3">
                            <img alt="avatar" src="/admin/src/assets/img/apple-app-store.svg"
