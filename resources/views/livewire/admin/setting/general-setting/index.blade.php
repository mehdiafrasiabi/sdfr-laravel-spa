        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                ...
                <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <label for="site_title" class="form-label">عنوان سایت :
                                <sup style="color: red">*</sup>
                            </label>
                            <input type="text" class="form-control" id="site_title" wire:model="site_title" name="site_title"
                                   placeholder="">
                        </div>
                    </div>
                    @error('site_title')
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <label for="site_description" class="form-label">توضیحات سایت :
                                <sup style="color: red">*</sup>
                            </label>
                            <input type="text" class="form-control" id="site_description" wire:model="site_description" name="site_description"
                                   placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="field-wrapper  mb-4" x-data="{isUploading:false,progress:0 }"
                        ...
                        <label for="thumbnail" class="form-label">لوگو هدر:</label>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($generalSetting as $general)
                            ...
                            <tr>
                                <td>
                                    {{$loop->iteration + $generalSetting->firstItem() - 1}}
                                </td>
                                <td>
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">{{$general->code}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">{{$general->type=='fixed'?'نقدی':'درصدی'}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                        ...
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">
                                                @if($general->type=='fixed')
                                                    {{number_format($general->value)}}هزار تومان
                                                @else
                                                    {{$general->value}}درصد
                                                @endif
                                            </h6>
                                ...
                                <td>
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">{{$general->limit}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">
                                                {{number_format($general->min_purchase)}}تومان
                                            </h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">{{jalali($general->expires_at)->format('%d %B %Y | h:i')}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">{{$general->is_active=='1'?'فعال':'غیرفعال'}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">{{$general->user_id == null ? 'همه': $general->user_id}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="media">
                                        <div class="media-body align-self-center">
                                            <h6 class="mb-0">{{$general->is_public=='1'?'عمومی':'خصوصی'}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="action-btns">
                                        ...
                                        <a href="javascript:void(0);" wire:click="edit({{$general->id}})"
                    ...
                    {{$generalSetting->links('layouts.admin.pagination')}}
                </div>
