        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                ...
                <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <label for="state" class="form-label">نام استان :
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <label class="form-label" for="country">انتخاب کشور مربوط :</label>
                            <sup style="color: red">*</sup>
                            <select class="form-select" name="countryId" id="country" wire:model="countryId2"
                                    wire:ignore>
