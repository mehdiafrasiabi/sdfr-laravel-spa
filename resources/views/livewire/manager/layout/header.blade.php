            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        ...
                        <span class="logo-sm">
                            <img  src="/manager/assets/images/logo-sm.png" alt="" height="120">
                        </span>
                            <span class="logo-lg">
                            <img src="/manager/assets/images/logo-dark.png" alt="" height="120">
                        </span>
                        </a>

                        <a href="{{route('manager.dashboard.crm')}}" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="/manager/assets/images/logo-sm.png" alt="" height="120">
                        </span>
                            <span class="logo-lg">
                            <img src="/manager/assets/images/logo-light.png" alt="" width="100px">
                        </span>
                        </a>
                    </div>
                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="tab-content position-relative" id="notificationItemsTabContent">
                                <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                <img src="/manager/assets/images/users/avatar-2.jpg"
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                <img src="/manager/assets/images/users/avatar-8.jpg"
                                                     class="me-3 rounded-circle avatar-xs" alt="کاربر-عکس">
                                                <div class="flex-grow-1">
                                                    <a href="#!" class="stretched-link">
                                ...
                                <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel"
                                    ...
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        <div class="text-reset notification-item d-block dropdown-item">
                                            <div class="d-flex">
                                                <img src="/manager/assets/images/users/avatar-3.jpg"
                                                     class="me-3 rounded-circle avatar-xs" alt="کاربر-عکس">
                                                <div class="flex-grow-1">
                                                    <a href="#!" class="stretched-link">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item">
                                            <div class="d-flex">
                                                <img src="/manager/assets/images/users/avatar-6.jpg"
                                                     class="me-3 rounded-circle avatar-xs" alt="کاربر-عکس">
                                                <div class="flex-grow-1">
                                                    <a href="#!" class="stretched-link">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="/manager/assets/images/users/avatar-1.jpg"
                                 alt="آواتار سرصفحه">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <h6 class="dropdown-header">خوش آمدی </h6>
                            <a class="dropdown-item" href="{{route('manager.dashboard.crm')}}"><i
                                    class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                    class="align-middle">نمایه</span></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="auth-logout-basic.html"><i
                                    class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span
                                    class="align-middle" data-key="t-logout">خروج از سیستم</span></a>
                        </div>
                    </div>
                </div>
            </div>
