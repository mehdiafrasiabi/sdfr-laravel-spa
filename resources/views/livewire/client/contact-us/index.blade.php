    ...
    <div class="max-w-7xl space-y-14 px-4 mx-auto">
        ...
        <div class="grid md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-5">
                ...
                <div class="bg-gradient-to-b from-secondary2 to-background2 rounded-2xl px-5 pb-5">
                    <!-- contact-us:title -->
                    ...
                    <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))" class="space-y-5">
                        <div class="space-y-1">
                            ...
                            <input type="text" id="fullname" name="name" wire:model="name"
                        ...
                        <div class="space-y-1">
                            <label for="tel" class="font-medium text-xs text-muted">تلفن همراه :</label>
                            <input type="tel" dir="ltr" id="tel" name="mobile" wire:model="mobile" max="11"
                                   placeholder="به طور مثال :09121234567"
                                   class="form-input w-full h-11 !ring-0 !ring-offset-0 bg-secondary border-border focus:border-border rounded-xl text-sm text-foreground px-5">
                            @error('mobile')
                            <div style="color: red;margin-right: 8px">{{$message}}</div>
                            @enderror
